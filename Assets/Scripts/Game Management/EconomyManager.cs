...
public class EconomyManager : MonoBehaviour
{
    ...
    // later these could be fetched from a json or something that stores the players stats like funds across different levels/play sessions
    GameManager gameManager;
    [HideInInspector] public int playersJunk; // use get set to make this available instead of public?
